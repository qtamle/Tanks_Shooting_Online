...
namespace Tanks.Complete
{
    ...
    public class StartMenuSlot : MonoBehaviour
    {
        ...
        public RectTransform m_ColorChoiceRoot; // The root of which all the Colors choice buttons are parented to
        ...
        public void AddTank()
        {
            ...
            m_ColorChoiceRoot.gameObject.SetActive(true);
        ...
        public void RemoveTank()
        {
            ...
            m_ColorChoiceRoot.gameObject.SetActive(false);
        ...
        public void SetPlayerTankColor(int colorNumber)
        {
            switch (colorNumber)
            {
                case 0:
                    m_SlotColor = Color.red;
                    SetTankColor(m_SlotColor);
                    red_Button.interactable = false;
                    blue_Button.interactable = true;

                    green_Button.interactable = true;
                    yellow_Button.interactable = true;
                    break;
                case 1:
                    m_SlotColor = Color.blue;
                    SetTankColor(m_SlotColor);
                    red_Button.interactable = true;
                    ...
                    break;
                case 2:
                    m_SlotColor = Color.green;
                    SetTankColor(m_SlotColor);
                    red_Button.interactable = true;
                    blue_Button.interactable = true;

                    green_Button.interactable = false;
                    yellow_Button.interactable = true;
                    break;
                case 3:
                    m_SlotColor = Color.yellow;
                    SetTankColor(m_SlotColor);
                    red_Button.interactable = true;
                    blue_Button.interactable = true;

                    green_Button.interactable = true;
                    yellow_Button.interactable = false;
                    break;
                default:
                    m_SlotColor = Color.white;
                    break;
            }
        }
